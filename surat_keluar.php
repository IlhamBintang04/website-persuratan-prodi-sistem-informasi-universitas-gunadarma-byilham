...
<head>
    <title>Surat Keluar - Penyuratan Prodi Sistem Infromasi</title>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href=" edit_surat_keluar.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                ...
                                ?>
                                <tr>
                                    <td colspan="8">Tidak ada data surat</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
